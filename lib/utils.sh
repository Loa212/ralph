...
# Assumes the script runs in the same timezone as reported by Codex
...
# Wait for Codex usage limit to reset with countdown
...
# Check if output indicates Codex usage limit
check_usage_limit() {
    local output_file=$1
